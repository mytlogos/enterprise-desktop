...
class DownloadTask extends Task<Void> {
    ...
    DownloadTask(int mediumId, List<Integer> episodeIds) {
    ...
    protected Void call() throws Exception {
        ...
        if (mediumId <= 0) {
            ...
            Thread.currentThread().setName(String.format("DownloadWorker-Medium-%d-Items-%d", mediumId, this.episodeIds.size()));
