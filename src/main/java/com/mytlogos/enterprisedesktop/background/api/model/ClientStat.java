...
public class ClientStat {
    ...
    public ClientStat(Map<String, Map<String, Partstat>> media, Map<String, List<Integer>> lists, Map<String, List<Integer>> extLists, Map<String, List<Integer>> extUser) {
        this.media = media;
        this.lists = lists;
    ...
    public static class ParsedStat {
        ...
        private ParsedStat(Map<Integer, Map<Integer, Partstat>> media, Map<Integer, List<Integer>> lists, Map<Integer, List<Integer>> extLists, Map<String, List<Integer>> extUser) {
            this.media = media;
            this.lists = lists;
            this.extLists = extLists;
            this.extUser = extUser;
    ...
    public ParsedStat parse() {
        ...
        return new ParsedStat(media, lists, extLists, this.extUser);
    }
}
