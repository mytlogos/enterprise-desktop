...
public class PreparedStatementImpl implements PreparedStatement {
    ...
    public boolean execute() throws SQLException {
        Log.info("Executing Execute Query on %s",Thread.currentThread());
    ...
    public long executeLargeUpdate() throws SQLException {
        Log.info("Executing executeLargeUpdate Query on %s",Thread.currentThread());
    ...
    public ResultSet executeQuery(String sql) throws SQLException {
        Log.info("Executing executeQuery Query on %s",Thread.currentThread());
        return new ResultSetImpl(delegate.executeQuery(sql));
    }

    @Override
    public int executeUpdate(String sql) throws SQLException {
        Log.info("Executing executeUpdate Query on %s",Thread.currentThread());
    ...
    public int[] executeBatch() throws SQLException {
        Log.info("Executing executeBatch Query on %s",Thread.currentThread());
    ...
    public long[] executeLargeBatch() throws SQLException {
        Log.info("Executing executeLargeBatch Query on %s",Thread.currentThread());
